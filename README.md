...
This plugin provides ReactJs, NodeJs project template in both JavaScript And TypeScript language that contain a very useful file structure, with middleware, controller, routes, models. And also configure all relevant packages like ESlint, Nodemon etc.
